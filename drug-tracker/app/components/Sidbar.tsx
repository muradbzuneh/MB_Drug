	...
	return (
		<aside className="w-full border-b border-[#1a2b49] bg-[#0b1630] px-4 py-5 text-slate-200 md:min-h-screen md:w-64 md:border-b-0 md:border-r md:px-5 md:py-7">
			<div className="flex items-center gap-3">
				<div className="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-500 text-sm font-bold text-white">✚</div>
				<div>
			...
			<div className="mt-8 border-t border-[#1a2b49] pt-4">
				<Link
					href="/login"
					className="flex items-center gap-2 rounded-lg border border-transparent px-3 py-2 text-sm text-slate-300 transition hover:border-slate-700 hover:bg-slate-800/50 hover:text-white"
				>
